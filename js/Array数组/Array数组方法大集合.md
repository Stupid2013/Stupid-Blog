...
写在前面：数组很多新方法`ie`低版本并不支持，可以来这儿[MDN Array](https://developer.mozilla.org/zh-CN/docs/Web/JavaScript/Reference/Global_Objects/Array)去看polyfill😎.

`copy`版本-->[array polyfill](./ie8-array-compatibility-polyfill.js)
